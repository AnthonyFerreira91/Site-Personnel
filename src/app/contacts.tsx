...
export const Contacts = () => {
	return (
		<div className='pt-1'>
			<Link href="https://github.com/Matrixfrpro33" className="bg-primary hover:scale-105 inline-flex gap-1.5 text-white items-center justify-center text-sm font-medium transition-all h-9 rounded-md px-3 mr-2" target='_blank'>
				<SiGithub /> GitHub
			</Link>
